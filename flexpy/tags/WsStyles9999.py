...
class WsStyles9999(NonRtTag):
    """A class for FLEx XML elements with the tag WsStyles9999
    ...
    def WsProp(self):
        """Gets the child objects which have short tag of `WsProp`, long tag of `WsProp`"""
