...
class RtCmOverlay(Rt):
    ...
    def PossItems(self):
        """Gets the child objects which have short tag of `PossItems`, long tag of `PossItems`"""
        return get_child_object(self.el, "PossItems", self.tag_dict)

    def PossList(self):
        """Gets the child objects which have short tag of `PossList`, long tag of `PossList`"""
