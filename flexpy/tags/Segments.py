...
class Segments(NonRtTag):
    """A class for FLEx XML elements with the tag Segments
    ...
    def RtPhPhoneme(self):
        """Gets the child objects which have short tag of `rt`, long tag of `RtPhPhoneme`, class name of `PhPhoneme`"""
        return get_child_object(self.el, "rt", self.tag_dict, class_name="PhPhoneme")

    def RtSegment(self):
        """Gets the child objects which have short tag of `rt`, long tag of `RtSegment`, class name of `Segment`"""
