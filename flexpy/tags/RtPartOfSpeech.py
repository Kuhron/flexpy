...
class RtPartOfSpeech(Rt):
    def __init__(self, rt, tag_dict):
        ...
        self.CatalogSourceId = get_child_object(self.rt, "CatalogSourceId", self.tag_dict)
        ...
        self.SubPossibilities = get_child_object(self.rt, "SubPossibilities", self.tag_dict)
