...
class RtPartOfSpeech(Rt):
    ...
    def CatalogSourceId(self):
        """Gets the child objects which have short tag of `CatalogSourceId`, long tag of `CatalogSourceId`"""
        return get_child_object(self.el, "CatalogSourceId", self.tag_dict)
