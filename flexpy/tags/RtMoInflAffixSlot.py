...
class RtMoInflAffixSlot(Rt):
    ...
    def Optional(self):
        """Gets the child objects which have short tag of `Optional`, long tag of `Optional`"""
        return get_child_object(self.el, "Optional", self.tag_dict)
