...
class RtLexEntryInflType(Rt):
    def __init__(self, rt, rt_dict):
        ...
        self.ReverseAbbr = get_child_object(self.rt, "ReverseAbbr", self.rt_dict)
        self.ReverseName = get_child_object(self.rt, "ReverseName", self.rt_dict)
        self.SortSpec = get_child_object(self.rt, "SortSpec", self.rt_dict)
        self.SubPossibilities = get_child_object(self.rt, "SubPossibilities", self.rt_dict)
