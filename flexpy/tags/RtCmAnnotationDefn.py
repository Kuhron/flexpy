...
class RtCmAnnotationDefn(Rt):
    def __init__(self, rt, tag_dict):
        ...
        self.AllowsComment = get_child_object(self.rt, "AllowsComment", self.tag_dict)
        self.AllowsFeatureStructure = get_child_object(self.rt, "AllowsFeatureStructure", self.tag_dict)
        self.AllowsInstanceOf = get_child_object(self.rt, "AllowsInstanceOf", self.tag_dict)
        self.BackColor = get_child_object(self.rt, "BackColor", self.tag_dict)
        self.CanCreateOrphan = get_child_object(self.rt, "CanCreateOrphan", self.tag_dict)
        self.CopyCutPastable = get_child_object(self.rt, "CopyCutPastable", self.tag_dict)
        ...
        self.InstanceOfSignature = get_child_object(self.rt, "InstanceOfSignature", self.tag_dict)
        self.IsProtected = get_child_object(self.rt, "IsProtected", self.tag_dict)
        self.MaxDupOccur = get_child_object(self.rt, "MaxDupOccur", self.tag_dict)
        self.Multi = get_child_object(self.rt, "Multi", self.tag_dict)
        self.Name = get_child_object(self.rt, "Name", self.tag_dict)
        self.PromptUser = get_child_object(self.rt, "PromptUser", self.tag_dict)
        self.Severity = get_child_object(self.rt, "Severity", self.tag_dict)
        ...
        self.UserCanCreate = get_child_object(self.rt, "UserCanCreate", self.tag_dict)
        self.ZeroWidth = get_child_object(self.rt, "ZeroWidth", self.tag_dict)
