...
class RtMoMorphType(Rt):
    ...
    def Postfix(self):
        """Gets the child objects which have short tag of `Postfix`, long tag of `Postfix`"""
        return get_child_object(self.el, "Postfix", self.tag_dict)

    def Prefix(self):
        """Gets the child objects which have short tag of `Prefix`, long tag of `Prefix`"""
        return get_child_object(self.el, "Prefix", self.tag_dict)

    def SecondaryOrder(self):
        """Gets the child objects which have short tag of `SecondaryOrder`, long tag of `SecondaryOrder`"""
        return get_child_object(self.el, "SecondaryOrder", self.tag_dict)
