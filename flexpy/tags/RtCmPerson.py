...
class RtCmPerson(Rt):
    def __init__(self, rt, rt_dict):
        ...
        self.DateOfBirth = get_child_object(self.rt, "DateOfBirth", self.rt_dict)
        self.DateOfDeath = get_child_object(self.rt, "DateOfDeath", self.rt_dict)
        ...
        self.Gender = get_child_object(self.rt, "Gender", self.rt_dict)
        ...
        self.IsResearcher = get_child_object(self.rt, "IsResearcher", self.rt_dict)
