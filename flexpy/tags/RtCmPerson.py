...
class RtCmPerson(Rt):
    ...
    def DateOfBirth(self):
        """Gets the child objects which have short tag of `DateOfBirth`, long tag of `DateOfBirth`"""
    ...
    def Gender(self):
        """Gets the child objects which have short tag of `Gender`, long tag of `Gender`"""
    ...
    def IsResearcher(self):
        """Gets the child objects which have short tag of `IsResearcher`, long tag of `IsResearcher`"""
