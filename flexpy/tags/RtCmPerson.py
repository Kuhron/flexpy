...
class RtCmPerson(Rt):
    def __init__(self, el, tag_dict):
        ...
        self.DateOfBirth = get_child_object(self.el, "DateOfBirth", self.tag_dict)
        self.DateOfDeath = get_child_object(self.el, "DateOfDeath", self.tag_dict)
        ...
        self.Gender = get_child_object(self.el, "Gender", self.tag_dict)
        ...
        self.IsResearcher = get_child_object(self.el, "IsResearcher", self.tag_dict)
