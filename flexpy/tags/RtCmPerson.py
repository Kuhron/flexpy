...
class RtCmPerson(Rt):
    def __init__(self, rt, tag_dict):
        ...
        self.DateOfBirth = get_child_object(self.rt, "DateOfBirth", self.tag_dict)
        self.DateOfDeath = get_child_object(self.rt, "DateOfDeath", self.tag_dict)
        ...
        self.Gender = get_child_object(self.rt, "Gender", self.tag_dict)
        ...
        self.IsResearcher = get_child_object(self.rt, "IsResearcher", self.tag_dict)
