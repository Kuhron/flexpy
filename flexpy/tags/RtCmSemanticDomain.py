...
class RtCmSemanticDomain(Rt):
    ...
    def LouwNidaCodes(self):
        """Gets the child objects which have short tag of `LouwNidaCodes`, long tag of `LouwNidaCodes`"""
        return get_child_object(self.el, "LouwNidaCodes", self.tag_dict)
    ...
    def OcmCodes(self):
        """Gets the child objects which have short tag of `OcmCodes`, long tag of `OcmCodes`"""
        return get_child_object(self.el, "OcmCodes", self.tag_dict)

    def Questions(self):
        """Gets the child objects which have short tag of `Questions`, long tag of `Questions`"""
        return get_child_object(self.el, "Questions", self.tag_dict)

    def RelatedDomains(self):
        """Gets the child objects which have short tag of `RelatedDomains`, long tag of `RelatedDomains`"""
        return get_child_object(self.el, "RelatedDomains", self.tag_dict)
