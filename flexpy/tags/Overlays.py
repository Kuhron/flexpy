...
class Overlays(NonRtTag):
    """A class for FLEx XML elements with the tag Overlays
    ...
    def RtCmOverlay(self):
        """Gets the child objects which have short tag of `rt`, long tag of `RtCmOverlay`, class name of `CmOverlay`"""
