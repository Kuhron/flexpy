...
class BasedOn(NonRtTag):
    """A class for FLEx XML elements with the tag BasedOn
    ...
    def RtStStyle(self):
        """Gets the child objects which have short tag of `rt`, long tag of `RtStStyle`, class name of `StStyle`"""
        return get_child_object(self.el, "rt", self.tag_dict, class_name="StStyle")
