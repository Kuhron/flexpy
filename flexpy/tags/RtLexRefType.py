...
class RtLexRefType(Rt):
    def __init__(self, el, tag_dict):
        ...
        self.MappingType = get_child_object(self.el, "MappingType", self.tag_dict)
        self.Name = get_child_object(self.el, "Name", self.tag_dict)
        self.ReverseAbbreviation = get_child_object(self.el, "ReverseAbbreviation", self.tag_dict)
