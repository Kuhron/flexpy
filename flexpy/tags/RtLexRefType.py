...
class RtLexRefType(Rt):
    ...
    def MappingType(self):
        """Gets the child objects which have short tag of `MappingType`, long tag of `MappingType`"""
        return get_child_object(self.el, "MappingType", self.tag_dict)

    def Name(self):
        """Gets the child objects which have short tag of `Name`, long tag of `Name`"""
        return get_child_object(self.el, "Name", self.tag_dict)

    def ReverseAbbreviation(self):
        """Gets the child objects which have short tag of `ReverseAbbreviation`, long tag of `ReverseAbbreviation`"""
        return get_child_object(self.el, "ReverseAbbreviation", self.tag_dict)
