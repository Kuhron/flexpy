...
class BoundaryMarkers(NonRtTag):
    """A class for FLEx XML elements with the tag BoundaryMarkers
    ...
    def RtPhBdryMarker(self):
        """Gets the child objects which have short tag of `rt`, long tag of `RtPhBdryMarker`, class name of `PhBdryMarker`"""
