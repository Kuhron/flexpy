...
def run_flashcards(project_name, tag_dict):
    ...
    for guid, elements_list in lex_entries.items():
        for lex in elements_list:
            ...
            for sense_element in senses_elements:
                ...
                for sense_objsur in sense_objsurs:
                    ...
                    for fcl in form_classes:
                        try:
                            lexeme_form_rt = tag_dict.get_single_element_by_tag_and_guid("MoStemAllomorph", lexeme_form_guid)
                    ...
                    sense_rt = tag_dict.get_single_element_by_tag_and_guid("LexSense", sense_guid)
